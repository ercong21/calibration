...
class XnliProcessor(DataProcessor):
    ...
    def get_test_dataset(self, args):
        ...
        test_set = [text_a+'\ '+text_b for text_a, text_b in zip(dataset['premise'], dataset['hypothesis'])]
    ...
    def get_examples(self, args, split):
        ...
        for i, data_ex in enumerate(dataset):
            guid = str(i)
            text_a = data_ex['premise']
            text_b = data_ex['hypothesis']
            label = data_ex['label']
...
class XnliMultiProcessor(DataProcessor):
    """Processor for the XNLI multilingual dataset."""
